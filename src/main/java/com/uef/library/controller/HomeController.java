...
@Controller
@RequiredArgsConstructor // Sử dụng Lombok để tự inject dependency
public class HomeController {
    ...
    public String viewCategories(Model model,
        ...
        model.addAttribute("bookPage", bookService.listAllBooks(keyword, categoryId, availability, pageable));
